...
export default function TabsLayout() {
  ...
  return <Tabs initialRouteName="home" screenOptions={({ route }) => ({
    ...
    tabBarStyle: [styles.bar, compact && styles.compactBar, Platform.OS === 'web' && styles.webBar, mobileWeb && styles.mobileWebBar],
    tabBarItemStyle: [styles.item, Platform.OS === 'web' && styles.webItem, mobileWeb && styles.mobileWebItem],
...
const styles = StyleSheet.create({
  bar: { backgroundColor: colors.surface, borderTopColor: colors.borderSubtle, borderTopWidth: 1, height: 76, paddingBottom: spacing.sm, paddingTop: spacing.xs, ...shadows.floating },
  compactBar: { height: 66, paddingBottom: spacing.xs, paddingTop: spacing.xxs },
  ...
  mobileWebBar: { bottom: 10, height: 60, maxWidth: 520, paddingBottom: 5, paddingHorizontal: 6, paddingTop: 5, width: '94%' },
  item: { minHeight: 48 }, webItem: { borderRadius: radius.lg, marginHorizontal: 4, minHeight: 42 },
  mobileWebItem: { flex: 1, marginHorizontal: 0, minHeight: 44 },
  ...
  mobileWebIconWrap: { flexDirection: 'column', gap: 0, height: 42, paddingHorizontal: 0, width: 48 },
  ...
  mobileWebScene: { paddingBottom: 78 },
